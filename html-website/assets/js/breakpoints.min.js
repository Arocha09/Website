var breakpoints=function(){
    ...
    var t={list:null,media:{},events:[],init:function(e){
                ...
                if(i=t.list[n],Array.isArray(i)){
                    if(r=parseInt(i[0]),d=parseInt(i[1]),isNaN(r)){
                        ...
                        if(isNaN(r))switch(a){
                            ...
                            return t.media[e]!==!1&&window.matchMedia(t.media[e]).matches},on:function(e,n){t.events.push({query:e,handler:n,state:!1}),t.active(e)&&n()},poll:function(){var e,n;
                        ...
                        !function(e,t){"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?module.exports=t():e.breakpoints=t()}(this,function(){return breakpoints});
